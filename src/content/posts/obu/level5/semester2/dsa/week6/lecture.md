...
与其让二叉搜索树又高又瘦，不如让它更矮更宽：这就是<span style="color: red">平衡化</span>。

## Balancing BST <br>平衡二叉搜索树

- Balanced Tree:<br>平衡树：
...
Check yourself: What is the code for the letter $P$? Try it yourself before reading on. It is :spoiler[0001]. What about the letter $D$? It is :spoiler[10].  
自测一下：字母 $P$ 的编码是什么？先自己试，再往下看。答案是 :spoiler[0001]。那 $D$ 呢？答案是 :spoiler[10]。
